...
class VectorStore:
    ...
    def insert_collection(self,doc,doc_embeddings):
        ...
        # 创建稀疏倒排索引
        sparse_index = {"index_type": "SPARSE_INVERTED_INDEX", "metric_type": "IP",'params': {}}
...
if __name__ == '__main__':
    ...
    # spilt = vector_db.split_text_files(docs)
    # print("split",spilt)
    #docs = vector_db.split_text_files(["ame.txt"])
    #print(docs)
    #插入数据库
    ...
    collection.load()
    queries = ["what is the name of author"]
    ...
    res = client.search(
        ...
        limit=3,
        search_params={"metric_type": "IP", "params": {'nlist': 1024, 'efConstruction': 40, 'M': 1024}},
